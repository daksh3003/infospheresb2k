    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="lg:hidden fixed top-0 left-0 z-40 w-full bg-white border-b border-gray-200 flex items-center justify-between px-4 h-16">
        <div className="flex items-center">
          ...
          <div className="ml-4 text-xl font-bold text-blue-800">B2K Dashboard</div>
        </div>
        <div className="flex items-center space-x-4">
          ...
          <Avatar>
            ...
            <AvatarFallback className="bg-blue-800 text-white">US</AvatarFallback>
          </Avatar>
        </div>
      </div>

      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-30 w-64 bg-blue-800 transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center h-16 px-6 border-b border-blue-700">
            ...
            <span className="text-xl font-bold text-white">Bytes 2 Knowledge</span>
          </div>
          ...
          <div className="p-4 border-t border-blue-700">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="w-full flex items-center text-left px-4 py-2 text-sm text-blue-100 hover:bg-blue-700 hover:text-white rounded-md">
                  <div className="flex items-center">
                    <Avatar className="h-8 w-8 mr-3">
                      <AvatarImage src="/avatars/user.png" />
                      <AvatarFallback className="bg-blue-900 text-white">US</AvatarFallback>
                    </Avatar>
                    <div>
